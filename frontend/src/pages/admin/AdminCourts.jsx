...
const emptyForm = {
  ...
  description: "",
  pricePerHour: 70000,
  services: DEFAULT_SERVICES.A.join("\n"),
  status: "active",
  imageUrls: "",
};
...
export default function AdminCourts() {
  ...
  const handleTypeChange = (newType) => {
    setForm((prev) => ({
      ...
      services: DEFAULT_SERVICES[newType]
        ? DEFAULT_SERVICES[newType].join("\n")
        : prev.services,
    }));
  };
      ...
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-page-subtitle">
            Thêm, sửa, phân loại sân & dịch vụ kèm theo
          </p>
        </div>
        <button
          onClick={openAdd}
                ...
                courts.map((court) => {
                  ...
                  return (
                    <tr key={court._id}>
                      ...
                      <td>
                        <span
                          className={`badge ${cType === "A" ? "badge-hot" : cType === "B" ? "badge-active" : "badge-inactive"}`}
                        >
                          Sân {cType} (
                          {cType === "A"
                            ? "VIP"
                      ...
                      >
                        ...
                        >
                          {court.services && court.services.length > 0
                            ? `${court.services.length} dịch vụ đi kèm`
                            : "Dịch vụ mặc định"}
                        </div>
                      </td>
            ...
            <form onSubmit={handleSave} className="admin-modal-form">
              ...
              <div className="form-group">
                <label className="form-label">
                  Dịch vụ đi kèm (Mỗi dịch vụ 1 dòng)
                </label>
                <textarea
                  rows={5}
                  value={form.services}
