    ...
    <div className="animate-fadeIn has-bottom-nav">
      ...
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            {courts.length} sân khả dụng · Sân A (70.000đ/h) · Sân B (50.000đ/h)
            · Sân C (30.000đ/h)
          </p>
        </div>
      </div>
      ...
      >
        ...
        >
          {Object.values(COURT_TIERS).map((tier) => {
            const countInTier = courts.filter(
              (c) => getCourtType(c) === tier.type,
            ).length;
            ...
            return (
              <div
                ...
                style={{
                  ...
                  borderRadius: 16,
                  border: isSelected
                    ? `2.5px solid ${tier.cardBorder}`
                    : "1px solid var(--border)",
                  boxShadow: isSelected
                    ? `0 8px 24px ${tier.cardBorder}33`
              ...
              >
                ...
                >
                  ...
                  >
                    {isSelected
                      ? "✓ Đang Lọc Loại Sân Này"
                      : `Xem Danh Sách ${tier.name}`}
                  </button>
                </div>
              </div>
            );
      ...
      {/* Court List */}
      <div
        style={{ maxWidth: 1200, margin: "0 auto", padding: "8px 16px 48px" }}
      >
        {loading ? (
          ...
          >
            ...
            >
              <Activity size={56} className="text-slate-300" />
            </div>
            <h3
              style={{
                fontWeight: 800,
            ...
            >
              Thử tìm kiếm với từ khóa khác hoặc xóa bộ lọc để xem toàn bộ danh
              sách sân.
            </p>
            <button
              onClick={() => {
          ...
          <>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              {filtered.map((court, idx) => {
                const isUnderMaintenance = court.status === "maintenance";
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderLeft: `5px solid ${tierInfo.cardBorder}`,
                    }}
                  >
                    {/* Thumbnail */}
                    <div
                      className="court-card-h__thumb"
                      style={{
                        width: 140,
                        minWidth: 140,
                        background: tierInfo.headerBg,
                      }}
                    >
                      <div
                        style={{
                    ...
                    >
                      ...
                      >
                        <div>
                          ...
                          >
                            ...
                            />
                            {court.description ||
                              "Sân cầu lông chất lượng cao với đầy đủ trang thiết bị tiêu chuẩn"}
                          </p>
                        </div>
                        <span
                          className={`badge ${isUnderMaintenance ? "badge-warning" : "badge-active"}`}
                          style={{ flexShrink: 0 }}
                        >
                          {isUnderMaintenance ? (
                            <>
                      ...
                      <div style={{ margin: "8px 0 12px" }}>
                        ...
                        >
                          <ShieldCheck
                            size={12}
                            style={{ color: tierInfo.tagColor }}
                          />{" "}
                          Dịch vụ bao gồm trong giá thuê:
                        </div>
                        <div
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {(
                              court.pricePerHour || tierInfo.price
                        ...
                        {isUnderMaintenance ? (
                          ...
                          >
                            <Wrench size={14} /> Sân đang bảo trì
                          </span>
                        ) : isAvailable ? (
                          user ? (
                            <Link
                              ...
                              style={{
                                background:
                                  "linear-gradient(135deg, #0D9D57, #1aaf64)",
                                color: "white",
                                padding: "9px 24px",
                                borderRadius: 999,
                                fontSize: 13,
