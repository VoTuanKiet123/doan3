  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 text-sm text-blue-700">
        ℹ️ Trang này dành cho bán hàng <strong>không gắn với phiên chơi</strong>{" "}
        (khách vãng lai ghé mua đồ). Dịch vụ cho khách đang chơi sân được thêm
        trực tiếp trong màn <strong>Check-in</strong>.
      </div>
